...
import 'package:nusapedia/data/about_app.dart';
import 'package:nusapedia/data/about_community.dart';
import 'package:nusapedia/data/whats_new.dart';
import 'package:nusapedia/presentation/pages/about_screen.dart';
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return ListTile(
                      ...
                      trailing: isSelected
                          ...
                          : null,
                      onTap: () {
                        // Pop everything until we reach the HomeScreen
                        // for cases where user changes language while inside an article
