...
import 'package:nusapedia/presentation/pages/create_page_screen.dart';
import 'package:nusapedia/presentation/pages/gallery_carousel_screen.dart';
import 'package:nusapedia/presentation/pages/image_screen.dart';
import 'package:nusapedia/presentation/widgets/wiki_footer.dart';
import 'package:nusapedia/presentation/widgets/custom_bottom_nav_bar.dart';
import 'package:nusapedia/presentation/widgets/custom_drawer.dart';
import 'package:nusapedia/presentation/providers/article_provider.dart';
import 'package:nusapedia/presentation/providers/language_provider.dart';
import 'package:nusapedia/presentation/providers/html_rules_provider.dart';
import 'package:nusapedia/presentation/providers/bookmarks_provider.dart';
import 'package:nusapedia/domain/entities/article.dart';
import 'package:nusapedia/core/theme_config.dart';
          ...
          child: HtmlWidget(
            ...
            customStylesBuilder: (element) {
              ...
              if (element.classes.contains('new')) {
                return {
                  'color':
                      '#${NusapediaThemeConfig.getLinkRed(theme.brightness).toARGB32().toRadixString(16).substring(2)}',
                };
              }
